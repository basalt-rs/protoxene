...
pub mod auth_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn login(
            ...
            let path = http::uri::PathAndQuery::from_static("/basalt.Auth/login");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new("basalt.Auth", "login"));
...
pub mod auth_server {
    ...
    pub const SERVICE_NAME: &str = "basalt.Auth";
